<!-- source: 30_LoRA_finetuning.ipynb -->

# Parameter-efficient fine-tuning with LoRA

This notebook is taken from the [Keras examples](https://keras.io/examples/nlp/parameter_efficient_finetuning_of_gpt2_with_lora/), and tuned a little bit to run on Colab.
...
BATCH_SIZE = 16
NUM_BATCHES = 500
EPOCHS = 3  # Can be set to a higher value for better results
